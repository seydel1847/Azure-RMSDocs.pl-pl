...
3. Możesz również sprawdzić, czy niektóre ustawienia zasad. Na przykład dokumentów i wiadomości e-mail nie muszą mieć etykietę, brak jest etykiety domyślnej i użytkownicy nie muszą uzasadniać ich zmieniać etykiety:
