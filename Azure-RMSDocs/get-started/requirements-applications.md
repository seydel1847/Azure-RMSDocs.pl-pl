...
description: "Poniższe informacje pozwalają zidentyfikować aplikacje, które w sposób natywny obsługują usługi Azure RMS, co oznacza, że usługi RMS zostały ściśle zintegrowane z tymi aplikacjami za pomocą interfejsów API usług RMS i obsługują ograniczenia użycia."
author: cabailey
manager: mbaldwin
ms.date: 08/25/2016
