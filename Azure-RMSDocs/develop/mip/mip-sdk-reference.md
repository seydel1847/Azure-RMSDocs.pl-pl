...
[MIP::PolicyEngine::Settings](class_mip_policyengine_settings.md) | Aby zainicjować aparatu, należy podać wystąpienia tej klasy przy użyciu odpowiednich parametrów.
[MIP::PrivilegedRequiredError](class_mip_privilegedrequirederror.md) | Bieżącej etykiety została ustawiona przez uprawnień nie można zastąpić metody przypisania.
