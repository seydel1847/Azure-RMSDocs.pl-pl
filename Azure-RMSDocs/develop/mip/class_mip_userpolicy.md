...
publiczny std::shared_ptr<TemplateDescriptor> GetTemplateDescriptor()  |  Pobiera [TemplateDescriptor](#classmip_1_1_template_descriptor) dla oparty na szablonie [UserPolicy](#classmip_1_1_user_policy).
publiczny std::shared_ptr<PolicyDescriptor> GetPolicyDescriptor()  |  Pobiera [PolicyDescriptor](#classmip_1_1_policy_descriptor) dla ad hoc [UserPolicy](#classmip_1_1_user_policy).
...
publiczny const std::vector<unsigned char> GetSerializedPolicy()  |  Serializować [UserPolicy](#classmip_1_1_user_policy) w licencji publikowania (PL)
publiczny std::shared_ptr < rmscore::core::ProtectionPolicy > GetImpl()  |  Implementacja klasy pochodnej pobiera wewnętrzne [UserPolicy](#classmip_1_1_user_policy).
