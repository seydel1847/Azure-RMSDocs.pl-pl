...
|-------------------|------------------------------|
|Przeprowadź migrację z lokalnej usługi Rights Management (AD RMS lub Windows RMS) do usługi Azure Information Protection.|[Import-AadrmTpd](/powershell/aadrm/vlatest/import-aadrmtpd)<br /><br />[Set-AadrmKeyProperties](/powershell/module/aadrm/set-aadrmkeyproperties)|
...
|Pobrać dziennik zadań administracyjnych usługi Rights Management dla swojej organizacji.|[Get-AadrmAdminLog](/powershell/module/aadrm/get-aadrmadminlog)|
