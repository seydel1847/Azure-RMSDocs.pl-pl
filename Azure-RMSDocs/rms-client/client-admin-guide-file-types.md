---
title: "Typy plików obsługiwane przez klienta usługi Azure Information Protection | Azure Information Protection"
...
### <a name="supported-file-types-for-protection-and-their-file-name-extensions"></a>Obsługiwane typy plików do ochrony i ich rozszerzenia nazw
Poniższa tabela zawiera listę typów plików, które są obsługiwane natywnie przez klienta usługi Azure Information Protection. W przypadku tych typów plików oryginalne rozszerzenie nazwy pliku zostaje zmienione po zastosowaniu do nich ochrony natywnej i pliki zyskują status tylko do odczytu.
...
Poniższa tabela zawiera listę typów plików, które są obsługiwane natywnie przez klienta usługi Azure Information Protection dla aplikacji pakietu Microsoft Office. Rozszerzenia nazw tych plików nie zmieniają się po objęciu plików ochroną przez usługę Rights Management.
