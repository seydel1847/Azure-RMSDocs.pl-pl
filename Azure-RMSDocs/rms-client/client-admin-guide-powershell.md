---
title: "Używanie środowiska PowerShell z klientem usługi Azure Information Protection | Azure Information Protection"
...
Moduł AzureInformationProtection obejmuje wszystkie polecenia cmdlet usługi Rights Management z narzędzia RMS Protection Tool i dwa nowe polecenia cmdlet, które korzystają z usługi Azure Information Protection (AIP) celem etykietowania:
...
## <a name="azure-information-protection-service-and-azure-rights-management-service"></a>Usługa Azure Information Protection i usługa Azure Rights Management
...
Utwórz nową jednostkę usługi, uruchamiając polecenie cmdlet `New-MsolServicePrincipal` z modułu MSOnline PowerShell usługi Azure Active Directory lub polecenie `New-AzureADServicePrincipal` z nowszej, drugiej wersji modułu PowerShell usługi Azure Active Directory. 

Poniższe instrukcje dotyczą polecenia New-MsolServicePrincipal z modułu MSOnline PowerShell usługi Azure Active Directory:
...
Zanim będzie można korzystać z ochrony plików, należy uzyskać listę szablonów usługi Rights Management i określić, który z nich będzie używany wraz z odpowiadającym im numerem identyfikacyjnym. Z raportu można też skopiować identyfikator szablonu:
