...
description: "Aby usunąć ochronę z pliku, który był wcześniej chroniony za pomocą aplikacji RMS sharing, skorzystaj z opcji Usuń ochronę w Eksploratorze plików."
author: cabailey
manager: mbaldwin
ms.date: 07/13/2016
ms.topic: article
