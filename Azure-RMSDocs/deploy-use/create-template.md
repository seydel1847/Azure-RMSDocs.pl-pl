...
1.  W zależności od tego, czy logowanie ma miejsce w Centrum administracyjnym usługi Office 365, czy też w klasycznym portalu Azure, wykonaj jedną z następujących czynności:
    ...
    -   Przejdź do [Centrum administracyjnego usługi Office 365](https://portal.office.com/):
        ...
        1.  W okienku po lewej stronie kliknij pozycję **Ustawienia usługi**..

        2.  Na stronie **Ustawienia usługi** kliknij pozycję **Rights Management**..

        3.  W sekcji **Ochrona informacji użytkownika** kliknij przycisk **Zarządzaj**..

        4.  W sekcji **Rights Management** kliknij pozycję **Zaawansowane funkcje**..

            > [!NOTE]
            > Jeśli usługa Rights Management nie została jeszcze aktywowana, najpierw kliknij pozycję **Aktywuj** i potwierdź wybór. Aby uzyskać więcej informacji, zobacz [Aktywacja usługi Azure Rights Management](activate-service.md).
            > 
    ...
    -   W [klasycznym portalu Azure ](http://go.microsoft.com/fwlink/p/?LinkID=275081):
        ...
        1.  W okienku po lewej stronie kliknij pozycję **ACTIVE DIRECTORY**..

        2.  Na stronie **Active Directory** kliknij pozycję **RIGHTS MANAGEMENT**..

        3.  Wybierz katalog, aby zarządzać usługą Rights Management.

        4.  Jeśli usługa Rights Management nie została jeszcze aktywowana, kliknij opcję **AKTYWUJ** i potwierdź wybór.
...
2.  Tworzenie szablonu:
    ...
    -   Na stronie szybkiego startu **Rozpoczynanie pracy z usługą Azure Rights Management** w klasycznym portalu Azure kliknij opcję **Utwórz nowy szablon zasad praw**..
        ...
        Jeśli ta strona nie zostanie wyświetlona natychmiast po wykonaniu instrukcji dotyczących usługi Office 365, skorzystaj z opisanych powyżej instrukcji dotyczących nawigacji dla klasycznego portalu Azure.
...
-   Aby usunąć użytkowników lub grupy, które wcześniej wybrano: kliknij opcję **PRAWA**, wybierz z listy użytkownika lub grupę, a następnie kliknij przycisk **USUŃ**..

-   Aby zmienić ustawienie widoczności szablonów, spośród których użytkownicy mogą wybierać z poziomu aplikacji: kliknij opcję **ZAKRES**, następnie kliknij przycisk **DODAJ** lub **USUŃ** albo **ZGODNOŚĆ APLIKACJI**..
