...
|------------------------|-------------------|
|Przeciek klucza dzierżawy.|Wymień klucz dzierżawy. Zobacz sekcję [Wymiana klucza dzierżawy](operations-microsoft-managed-tenant-key.md#rekey-your-tenant-key) w tym artykule.|
