...
- Aby uzyskać instrukcje dotyczące migracji z usług AD RMS, zobacz [Migrowanie z usług AD RMS do usługi Azure Information Protection](../plan-design/migrate-from-ad-rms-to-azure-rms.md).
...
Aby skonfigurować etykiety dla ochrony HYOK, zobacz [sposobu konfigurowania etykiety dla ochrony usługi Rights Management](../deploy-use/configure-policy-protection.md). 
