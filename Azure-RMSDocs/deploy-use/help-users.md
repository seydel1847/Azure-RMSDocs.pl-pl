...
description: "Po wdrożeniu i skonfigurowaniu usługi Azure Rights Management (Azure RMS) w Twojej organizacji należy zapewnić pomoc i wskazówki dla użytkowników, administratorów i działu pomocy technicznej."
author: cabailey
manager: mbaldwin
ms.date: 06/09/2016
ms.topic: article
