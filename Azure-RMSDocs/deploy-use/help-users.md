...
-   **Informacje dla działu pomocy**
    ...
    - **Problemy dotyczące ochrony lub używania zawartości**
        ...
        Jeśli prawa, które mają użytkownicy są niezgodne z oczekiwaniami, sprawdź opis praw i implementacji specyficznych dla aplikacji z [tabeli praw użytkowania](../deploy-use/configure-usage-rights.md#usage-rights-and-descriptions).
