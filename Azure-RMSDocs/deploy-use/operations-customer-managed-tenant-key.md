...
description: "Informacje na temat operacji cyklu życia, które są istotne, jeśli zarządzasz swoim kluczem dzierżawy dla usługi Azure Rights Management (zgodnie ze scenariuszem używania własnego klucza — BYOK, Bring Your Own Key)."
author: cabailey
manager: mbaldwin
ms.date: 08/25/2016
ms.topic: article
