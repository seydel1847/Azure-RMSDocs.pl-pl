...
Aby uzyskać więcej informacji o tych certyfikatach zewnętrznych, zobacz artykuł [Centrum zaufania usługi Azure](http://azure.microsoft.com/support/trust-center/compliance/).

## Następne kroki

Aby poznać usługę Azure RMS dla administratorów i użytkowników, zobacz artykuł [Usługa Azure RMS w akcji](what-admins-users-see.md).
