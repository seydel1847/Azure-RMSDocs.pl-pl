...
Aby uzyskać więcej informacji, która obejmuje sprawdzanie stanu aktywacji, zobacz [Aktywacja usługi Azure Rights Management](../deploy-use/activate-service.md).
